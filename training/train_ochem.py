...
parser.add_argument("--model", required=False, help="Graph model to train.", default="R-GIN")
parser.add_argument("--dataset", required=False, help="Name of the dataset or leave empty for custom dataset.",
                    default="OCHEMDataset")
parser.add_argument("--hyper", required=False, help="Filepath to hyperparameter config file (.py or .json).",
                    default="hyper/hyper_ochem.py")
...
# Those sub-classed classes are named after the dataset like e.g. `OCHEMDataset`
